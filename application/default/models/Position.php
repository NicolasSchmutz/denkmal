...
class Position
{
	...
	public function getX() {
		...
		if ($x < self::$_mapSize['xMin']) { $x = self::$_mapSize['xMin']; }
		if ($x > self::$_mapSize['xMax']) { $x = self::$_mapSize['xMax']; }  
		return $x;
	}
	...
	public function getY() {
		...
		if ($y < self::$_mapSize['yMin']) { $y = self::$_mapSize['yMin']; }
		if ($y > self::$_mapSize['yMax']) { $y = self::$_mapSize['yMax']; } 
		return $y;
	}
